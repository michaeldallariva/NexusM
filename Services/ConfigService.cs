...
public class ConfigService
{
    ...
    private void LoadConfig()
    {
        try
        {
            ...
            if (server != null)
            {
                _config.Server.ServerPort = ParseInt(server["ServerPort"], 8501);
            ...
            {
                _logger.LogWarning("ServerPort {Port} is outside valid range 1-65535, defaulting to 8501", _config.Server.ServerPort);
                _config.Server.ServerPort = 8501;
            }
